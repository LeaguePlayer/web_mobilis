	...
	<?
		...
		if (!empty($data))
		{
			foreach ($data as $key_d=>$value)
			{
				...
				if($images[0]['rank'])
				{
					print('<div class="kitchen"><div class="view"><img style="width=323;height=216;	" src="/'.$images[0]['galleryDir'].'/'.$images[0]['rank'].'cat_list_large.'.$images[0]['ext'].'" ></div><div class="thumbs">');
