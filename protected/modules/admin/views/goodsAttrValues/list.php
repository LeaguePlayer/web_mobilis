...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'goods-attr-values-grid',
	'dataProvider'=>$model->search(),
	'filter'=>$model,
	'type'=>TbHtml::GRID_TYPE_HOVER,
    'afterAjaxUpdate'=>"function() {sortGrid('goodsattrvalues')}",
...
<?php Yii::app()->clientScript->registerScript('sortGrid', 'sortGrid("goodsattrvalues");', CClientScript::POS_END) ;?>