...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	'id'=>'category-attrs-grid',
	'dataProvider'=>$model->search(),
	'filter'=>$model,
	'type'=>TbHtml::GRID_TYPE_HOVER,
    'afterAjaxUpdate'=>"function() {sortGrid('categoryattrs')}",
...
<?php Yii::app()->clientScript->registerScript('sortGrid', 'sortGrid("categoryattrs");', CClientScript::POS_END) ;?>