<?php
/**
 * Миграция m131211_062629_goods_attr_values
 *
 * @property string $prefix
 */
 
class m131211_062629_goods_attr_values extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{goods_attr_values}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{goods_attr_values}}', array(
            'id' => 'pk', // auto increment
            'goods_id' => "int COMMENT 'Товар'",
			'attr_id' => "int COMMENT 'Категория'",
			'attr_value' => "string COMMENT 'Значение'",
