<?php
/**
 * Миграция m131211_062643_category_attrs
 *
 * @property string $prefix
 */
 
class m131211_062643_category_attrs extends CDbMigration
{
    // таблицы к удалению, можно использовать '{{table}}'
	private $dropped = array('{{category_attrs}}');
    ...
    public function safeUp()
    {
        ...
        $this->createTable('{{category_attrs}}', array(
            'id' => 'pk', // auto increment

			'category_id' => "int COMMENT 'Комментарий'",
			'name' => "string COMMENT 'Название'",
            'discription' => "string COMMENT 'Описание'",
